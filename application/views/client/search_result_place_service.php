...
<?php if(isset($ServiceTypeSearchAndPlaceResultsForAppartment)) : ?>
    <?php if(count($ServiceTypeSearchAndPlaceResultsForAppartment) > 0): ?>
        <?php foreach($ServiceTypeSearchAndPlaceResultsForAppartment as $sd) {
    ...
    <?php endif;?>
        ...
        <div class="row">
            <div class="col-md-12">
                <h2 class=" text-center">Showing result for  <b><u><?php if(isset($title)) echo $title; ?></u></b></h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
        <?php if(isset($ServiceTypeSearchAndPlaceResultsForLand)): ?>
            <?php if(count($ServiceTypeSearchAndPlaceResultsForLand) > 0): ?>
                <?php foreach($ServiceTypeSearchAndPlaceResultsForLand as $sd): ?>
                    <div style="margin-top:10px; !important" class="col-lg-4 col-md-6 col-sm-6 col-xs-12" >
                        <div class="hovereffect">
