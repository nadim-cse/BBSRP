...
<?php if(isset($ServiceTypeSearchResultsForAppartment)) : ?>
    <?php if(count($ServiceTypeSearchResultsForAppartment) > 0): ?>
        <?php foreach($ServiceTypeSearchResultsForAppartment as $sd) {
    ...
    <?php endif;?>
        ...
        <div class="row">
            <div class="col-md-12">
                <h2 class=" text-center">Showing result for  <b><u><?php if(isset($ServiceType)) echo $ServiceType; ?></u></b></h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
        <?php if(isset($ServiceTypeSearchResultsForLand) == 'Sell'): ?>
            <?php if(count($ServiceTypeSearchResultsForLand) > 0): ?>
                <?php foreach($ServiceTypeSearchResultsForLand as $sd): ?>
                    <div style="margin-top:10px; !important" class="col-lg-4 col-md-6 col-sm-6 col-xs-12" >
                        <div class="hovereffect">
