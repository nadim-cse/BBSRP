...
<?php if(isset($ServiceAllFormetForAppartment)) : ?>
    <?php if(count($ServiceAllFormetForAppartment) > 0): ?>
        <?php foreach($ServiceAllFormetForAppartment as $sd) {
    ...
    <?php endif;?>
        ...
        <div class="row">
        <?php if(isset($ServiceAllFormetForLand)): ?>
            <?php if(count($ServiceAllFormetForLand) > 0): ?>
                <?php foreach($ServiceAllFormetForLand as $sd): ?>
                    <div style="margin-top:10px; !important" class="col-lg-4 col-md-6 col-sm-6 col-xs-12" >
                        <div class="hovereffect">
