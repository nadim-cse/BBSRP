            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-6 col-xs-6">
                        ...
                        <a href="<?php echo site_url('Services/MyAccountForLandtEdit/'.$sd->land_id); ?>"><span class="fa fa-pencil-square-o" aria-hidden="true"></span>Edit</a>&nbsp;
                        </h5>
                       
                    </div>
                    <div class="col-md-6 col-xs-6">
                        <h5 class="text-center custom-btb-txt">
                        <a href="<?php echo site_url('Services/DeleteAdForLand/'.$sd->land_id); ?>" onclick ="return confirmDialog();"><span class="fa fa-trash" aria-hidden="true"></span> Remove</a>
