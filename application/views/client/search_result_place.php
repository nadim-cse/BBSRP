...
<?php if(isset($PlaceSearchResultsForAppartment)) : ?>
    <?php if(count($PlaceSearchResultsForAppartment) > 0): ?>
        <?php foreach($PlaceSearchResultsForAppartment as $sd) {
    ...
    <?php endif;?>
        ...
        <div class="row">
        <?php if(isset($PlaceSearchResultsForLand)): ?>
            <?php if(count($PlaceSearchResultsForLand) > 0): ?>
                <?php foreach($PlaceSearchResultsForLand as $sd): ?>
                    <div style="margin-top:10px; !important" class="col-lg-4 col-md-6 col-sm-6 col-xs-12" >
                        <div class="hovereffect">
